...
{
    internal class DemoMenuConsole : ControlsConsole
    {
        Color[] backgroundcycle;
        int backIndex = 0;
        SadConsole.Timer progressTimer;

        public DemoMenuConsole() : base(80, 23)
        {
            ...
            button.AlternateFont = SadConsole.Global.LoadFont("Content/Fonts/Cheepicus12.font").GetFont(Font.FontSizes.One);
            Add(button);
